...
/**
 * Created by jjhu on 2017/2/8.
 */
public class Test {

    public static void main(String[] args) throws IOException {
//        InputUser.AppList.App app1 = InputUser.AppList.App.newBuilder()
//                .setPkg("com.tencent.qq")
//                .setName("QQ")
//                .build();
//        InputUser.AppList.App app2 = InputUser.AppList.App.newBuilder()
//                .setPkg("com.tencent.weixin")
//                .setName("weixin")
//                .build();
//        InputUser.AppList appList = InputUser.AppList.newBuilder()
//                .addApps(app1)
//                .addApps(app2)
//                .build();
//
//        byte []appArr = appList.toByteArray();
//
//        InputUser.AppList desAppList = InputUser.AppList.parseFrom(appArr);
//        for (InputUser.AppList.App tmp : desAppList.getAppsList()){
//            System.out.println("Pkg: " + tmp.getPkg() + " Name:" + tmp.getName());
//        }
